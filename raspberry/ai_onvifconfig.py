...
class ptzcam():
    ...
    #Netcat camera (on my local network) Port 8899
        self.mycam = ONVIFCamera('192.168.0.61', 10080, 'admin', 'password', '/home/pi/Downloads/python-onvif/wsdl/')
...
#Continuous move functions
    ...
    def move_PT(self, velocity_x, velocity_y, timeout):
        print 'Move pantilt...', velocity_x, velocity_y, timeout
        self.requestc.Velocity.PanTilt._x = velocity_x
        self.requestc.Velocity.PanTilt._y = velocity_y
        self.perform_move(timeout)
